...
import musicplus.musicfilemanager.music.mp3.id3.FrameBodyGNID;
import musicplus.musicfilemanager.music.mp3.id3.ID3Version;
import musicplus.musicfilemanager.music.mp3.id3.Id3KnownTagNames;

public class ID3v2Wrapper implements Iterable<Id3V2FrameWrapper>{
	...
	@Override
	public Iterator<Id3V2FrameWrapper> iterator() {
		List<Id3V2FrameWrapper> id3FrameWrapperList = new ArrayList<>();
		if(id3V2Tag!=null){
			Iterator<AbstractID3v2Frame> iterator = id3V2Tag.iterator();
			while(iterator.hasNext()){
				AbstractID3v2Frame it = iterator.next();
				Id3V2FrameWrapper id3FrameWrapper = new Id3V2FrameWrapper(it);
	...
	public Id3KnownTagNames getTagName(Id3V2FrameWrapper frame){
	...
	public void addNewTag(Id3KnownTagNames tagName,String value){
		...
		Id3V2FrameWrapper frameWrapper = new Id3V2FrameWrapper(abstractId3Frame);
//		id3V2FrameWrapper.setKey(tagName.);
	...
	public void setKnownTagValue(Id3KnownTagNames tagName,String value){
		...
		for(Id3V2FrameWrapper tag:this){
	...
	public boolean isKnownTagName(Id3V2FrameWrapper frame){
